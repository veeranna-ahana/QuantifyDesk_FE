// src/components/ui/LoadingSkeleton/LoadingSkeleton.jsx
// Promoted from features/projects/components/LoadingSkeleton.jsx
...
export function LoadingSkeleton({ rows = 10 }) {
  return (
    <div className="w-full">
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="grid grid-cols-7 gap-4 px-5 py-[18px] border-b border-gray-50 last:border-0">
